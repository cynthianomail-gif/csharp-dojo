...
function LessonNode({ lesson, color, glow, onClick, status, isBoss }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
      ...
      <div style={{
        fontSize: 9.5,
        color: status === 'locked' ? 'var(--text-3)' : 'var(--text-1)',
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 14 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <span style={{
              ...
              border: `1px solid ${stage.color}55`, background: `${stage.color}18`,
              color: stage.color,
            }}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--text-2)' }}>
              {doneCount}/{stageLessons.length}
            </span>
          </div>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 17, fontWeight: 700, color: 'var(--text-0)' }}>
            {stage.title}
          </div>
        ...
        <div style={{
          ...
          color: doneCount === stageLessons.length ? 'var(--ok)' : 'var(--text-2)',
        }}>
      ...
      <div style={{
        display: 'grid',
        gridTemplateColumns: `repeat(${Math.min(5, stageLessons.length)}, 1fr)`,
        gap: 12, rowGap: 16, alignItems: 'start',
      }}>
      ...
      <div style={{
        ...
        borderTop: `1px dashed ${stage.color}33`,
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%', background: 'var(--bg-0)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', padding: '14px 20px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
          <button style={{ background: 'transparent', border: 'none', color: 'var(--text-1)', padding: 4 }}>
            <Icons.Menu size={20} />
          </button>
          <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 10 }}>
            <div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--text-2)', letterSpacing: '0.15em', marginBottom: 3 }}>
                YOUR JOURNEY
              </div>
          ...
          <div style={{ height: 6, borderRadius: 99, background: 'var(--bg-2)', overflow: 'hidden' }}>
            <div style={{
              ...
              boxShadow: '0 0 12px var(--accent)', borderRadius: 99,
      ...
      <div className="no-scrollbar" style={{
        position: 'relative', height: 'calc(100% - 190px)',
        overflowY: 'auto', padding: '14px 20px 100px',
      ...
      <div style={{
        ...
        background: 'rgba(11,11,18,0.88)', backdropFilter: 'blur(12px)',
        borderTop: '1px solid var(--line)', padding: '10px 20px 20px',
        display: 'flex', justifyContent: 'space-around',
      }}>
        {[
          { label: '地圖', icon: <Icons.Cube size={20} />, active: true },
          { label: '練習', icon: <Icons.Sword size={20} /> },
          { label: '成就', icon: <Icons.Trophy size={20} /> },
          { label: '我的', icon: <Icons.Star size={20} /> },
        ].map((tab, i) => (
          <div key={i} style={{
            ...
            {tab.icon}
            <span style={{ fontSize: 9.5, fontWeight: 600, fontFamily: 'var(--font-mono)' }}>{tab.label}</span>
          </div>
        ))}
      </div>
    </div>
